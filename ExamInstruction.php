<?php
// include 'header.php';
// include 'menubar.php'; student instructions
...
<dl>
	...
	<dd>
		<ul type="1">
			...
			<li>We will Provide Online Calculator for Calculations.</li>
            ...
            <li>After Login(seeing questions), don't Logout before completion of exam.</li>
            <li>During Examination, don't Close the <span style="font-weight: bold;">Browser Window.</span></li>
			<li>During Examination, don't <span style="font-weight: bold;color:red;">Refresh</span> the
			<span style="font-weight: bold;">Browser Window.</span></li>
		</ul>
	</dd>
