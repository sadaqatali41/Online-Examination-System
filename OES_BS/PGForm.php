	...
	<div class="container">
		<div class="row">
				...
				<div class="col-sm-6 text-right">
					<a href="StudentSignOut.php" class="btn btn-primary">Sign Out</a>
				</div>
		</div>
			<div id="pgform">
		<?php
			if(isset($_POST['submit']))
			{
				...
				if($code==FilterData($_POST['code']))
				{
					...
					{
						echo "<p class='alert alert-success text-center'><strong>$rs1 .Your Record for Post Graduation is Inserted!<br>
								Now Login Again.</strong></p>";
								header('refresh:5;url=StudentSignOut.php');
					}
					else
					{
						echo "<p class='alert alert-warning text-center'><strong>Sorry! Your Records is not Inserted,
