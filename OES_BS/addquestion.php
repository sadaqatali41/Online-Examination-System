...
{
	header('location:http://localhost/OnlineExamination1/adminlogin.php');
}
			...
			{	
				...
				if(mysqli_affected_rows($con)>0)
				{
					echo "<p class='alert alert-success text-center'>$result1. Question is Inserted Successfully.</p>";
							header('refresh:3;url=addquestion.php');
				}
				else
				{
				...
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<div class="row">
							...
							<div class="col-sm-4">
								<a href="welcomadmin.php" class="btn btn-block btn-info">&#8810; Go Back</a>
							</div>
						</div>
					</div>
				</div>
