		...
		<?php
			if(isset($_POST['submit']))
			{
				...
				if($code==$_POST['code'])
				{
					...
					{
						echo "<p class='alert alert-success text-center'><strong>Your Password has been Changed Successfully.
						</strong></p>";
								header('refresh:3;url=StudentSignOut.php');
					}
					else
					{
						echo "<p class='alert alert-danger text-center'><strong>Sorry! We are Unable To Processing, Try Again
							   Later.</strong></p>";
					}
					mysqli_close($con);
				}
