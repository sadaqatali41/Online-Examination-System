			...
			<?php
				...
				if(isset($_POST['submit']))
				{
					...
					if($otp==$_SESSION['OTP'])
					{
						...
						header('location:http://localhost/OES_BS/forget-password-two');
						
					}
					else
					{
						setcookie('error',"<p class='alert alert-danger text-center'><strong>Sorry! OTP is Incorrect.</strong></p>",time()+3);
						header('location:http://localhost/OES_BS/forget-password-two');
					}
				}
			?>
